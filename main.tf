...
# We also need to route our private subnet out to the internet to allow our Kubernetes Pods to talk to the EKS service.
# We need a NAT and an EIP (real IP)
...
## And finally routes for our private subnets
